...
% q=q';
% franka.plot(q(:,1:20:end)','floorlevel',0,'trail','-r','linkcolor',light_grey,'jointcolor',black)
% xlim([-1 1])
% ylim([-1 1])
% zlim([0 2])
% xlabel('X [m]')
...
hold on
plot3(p(1,:),p(2,:),p(3,:))
KUKA.plot(q_des','floorlevel',0,'trail','-b','linkcolor',light_grey,'jointcolor',black)
