%MDL_FRANKA Create model of Franka-Emika PANDA robot
%
% MDL_FRANKA is a script that creates the workspace variable panda which
...
function r = mdl_franka()
    ...
    robot = SerialLink([L1 L2 L3 L4 L5 L6 L7], 'name', 'FRANKA', 'manufacturer', 'Franka-Emika', 'tool', transl([0 0 110*mm]));
