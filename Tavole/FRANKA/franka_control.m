...
franka.plot(qv1,'floorlevel',0,'linkcolor',light_grey,'jointcolor',black)
% lims  plot
xlim([-1 1])
ylim([-1 1])
zlim([0 2])
...
for i=1:n
	franka.plot(q(i,:),'floorlevel',0,'linkcolor',light_grey,'jointcolor',black)
end
...
for i=1:length(t)
	franka.plot(q_des(:,i)','floorlevel',0,'linkcolor',light_grey,'jointcolor',black)
	hold on
