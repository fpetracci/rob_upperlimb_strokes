...
% 14 scazzato completamente, non si capisce cosa faccia FARE SOLO RESAMPLE
s1 = correct2pi_err(q_task(14).subject(2).trial(2).q_grad(:,10:end));% molto resemplato task problematico
...
s1 = correct2pi_err(q_task(29).subject(18).trial(5).q_grad(:,10:end)); % angoli negativi
