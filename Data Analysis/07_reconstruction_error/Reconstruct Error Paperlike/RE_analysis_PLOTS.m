...
%	exportgraphics(f,['shadow_HSLA.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
%	exportgraphics(f,['shadow_D_10.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
% 	exportgraphics(f,['shadow_D_7.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
% 	exportgraphics(f,['shadow_D_3.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
% 	exportgraphics(f,['shadow_ND_10.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
% 	exportgraphics(f,['shadow_ND_7.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i)
%	exportgraphics(f,['shadow_ND_3.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
%% without healty
	set(gca,'FontSize',13)
	set(findall(gcf,'type','text'),'FontSize',13)
	set(gcf, 'Position',  [200, 0, 650, 650])
	...
	f = gcf;
	%f.WindowState = 'maximize';
%	exportgraphics(f,['shadow_SLA.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
%	exportgraphics(f,['shadow_D_10_NOH.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
% 	exportgraphics(f,['shadow_D_7_NOH.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
% 	exportgraphics(f,['shadow_D_3_NOH.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
% 	exportgraphics(f,['shadow_ND_10_NOH.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
% 	exportgraphics(f,['shadow_ND_7_NOH.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i)
	exportgraphics(f,['shadow_ND_3_NOH.pdf'], 'ContentType','vector','BackgroundColor','none') %num2str(i) 
end
