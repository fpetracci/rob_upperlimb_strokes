...
%	exportgraphics(f,['shadow_D_10.pdf'], 'ContentType','vector') %num2str(i) 
% 	exportgraphics(f,['shadow_D_7.pdf'], 'ContentType','vector') %num2str(i) 
% 	exportgraphics(f,['shadow_D_3.pdf'], 'ContentType','vector') %num2str(i) 
% 	exportgraphics(f,['shadow_ND_10.pdf'], 'ContentType','vector') %num2str(i) 
% 	exportgraphics(f,['shadow_ND_7.pdf'], 'ContentType','vector') %num2str(i)
%exportgraphics(f,['shadow_ND_3.pdf'], 'ContentType','vector') %num2str(i) 
end
