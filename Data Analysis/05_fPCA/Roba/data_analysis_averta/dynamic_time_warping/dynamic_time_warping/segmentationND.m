function [ s1,s2,s3 ] = segmentationND(sm)
%this functions splits a multidim signal in 3 segments in order to divide 3
%repetitions of a signal

%sm is a 7*Nsamples matrix. Select just 1 signal for segmentation (line4)
