...
disp('Press any key to watch the animation of the reconstructed arm movements.')
disp('Only active arm is calculated and shown')
pause
armplot(q_trial.q_grad, arm_task, trial)
...
%plot_lims-----------------------------------------------------------------
function lims = plot_lims(trial, lim_gap)
